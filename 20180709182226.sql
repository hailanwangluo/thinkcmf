...
MySQL Backup
Database: cltphp_db
Backup Time: 2018-07-12 17:42:26
*/

SET FOREIGN_KEY_CHECKS=0;
DROP TABLE IF EXISTS `cltphp_db`.`clt_ad`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_ad_type`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_admin`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_article`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_auth_group`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_auth_rule`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_category`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_config`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_debris`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_debris_type`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_donation`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_download`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_feast`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_feast_element`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_field`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_link`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_message`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_module`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_oauth`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_page`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_picture`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_plugin`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_posid`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_product`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_region`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_role`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_role_user`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_system`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_team`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_user_level`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_users`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_wx_auth`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_wx_config`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_wx_default_replay`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_wx_fans`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_wx_follow_replay`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_wx_key_replay`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_wx_media`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_wx_media_item`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_wx_menu`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_wx_user`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_wx_user_msg`;
DROP TABLE IF EXISTS `cltphp_db`.`clt_wx_user_msg_replay`;
CREATE TABLE `clt_ad` (
...
) ENGINE=MyISAM AUTO_INCREMENT=37 DEFAULT CHARSET=utf8 COMMENT='广告表';
...
CREATE TABLE `clt_feast` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='节日列表';
