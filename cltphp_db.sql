...
(8,'毛豆豆1','14e1b600b1fd579f47433b88e8d85291',2,'8234738438@qq.com','0','18767654897','127.0.0.1',1498815814,'0',1,'/uploads/20180625/444914e4eb7ad1f5d359211a9b72805b.jpg');
...
(38,3,1,'admin','关于CLTPHP的一些琐碎事','关于CLTPHP的一些琐碎事 cltphp cltphp内容管理系统 php','CLTPHP的目的是 让所有人都能 高效 简洁 的建立网站，虽然世界上有成千上万的建站系统，但CLTPHP会告诉你，真正高效的建站系统是什么样的。','<p>CLTPHP是开源的</p><p><a href=\"http://demo.cltphp.com\" target=\"_self\" title=\"CLTPHP演示站\">CLTPHP演示站</a>的后台用户名：admin &nbsp;密码：admin123</p><p>版本更新包的后台用户名：admin &nbsp;密码：admin123</p><p>新版本发布，请登录后台，清空缓存后再打开前台，不然，前台可能会报错。</p><p><span style=\"color: rgb(149, 55, 52);\">如果没有意外（睡眼忪惺）的时候，以上永久不变。</span></p>','0',1,'1',0,'',0,0,1263,1505264319,1515748920,'CLTPHP','http://www.cltphp.com/','',''),
...
CREATE TABLE `clt_auth_rule` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=277 DEFAULT CHARSET=utf8 COMMENT='权限节点';
...
(1,'CLTPHP','http://www.cltphp.com/','CLTPHP','CLTPHP,CLTPHP内容管理系统,php','CLTPHP内容管理系统，微信公众平台、APP移动应用设计、HTML5网站API定制开发。大型企业网站、个人博客论坛、手机网站定制开发。更高效、更快捷的进行定制开发。','陕ICP备15008093号-3','2015-2020','西安市雁塔区','18792402229','1109305987@qq.com','/uploads/20180608/55624159eb051a6c5e9bfadff49bf731.png','open','open');
...
(1,'1109305987@qq.com','e10adc3949ba59abbe56e057f20f883e',NULL,1,0,1516075631,0,'','','44311',0,'',NULL,NULL,'/uploads/20180613/fcb729987d8e9339bd9b2e85c85f3028.jpg',24,311,2599,0,'chichu',1,0,'','不要应为走得太远，就忘了当初为什么出发！','hide');
